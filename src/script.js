...
const normalTexture = textureLoader.load('/textures/height2NormalMap.png')
...
//light 2
const pointLight2 = new THREE.PointLight(0x87ff, 2)
pointLight2.position.set(2.04, 3, .37)
pointLight2.intensity = 2.36
...
pointLight3.position.set(-3.29, -3, -.54)
